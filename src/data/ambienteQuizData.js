...
export const AMBIENTES = [
  { value: 'varanda_sacada', label: 'Varanda e Sacada' },
  { value: 'sala_estar', label: 'Sala de Estar / Home Theater' },
  { value: 'quarto', label: 'Quarto' },
  { value: 'cozinha_lavanderia', label: 'Cozinha e Lavanderia' },
  { value: 'banheiro_lavabo', label: 'Banheiro e Lavabo' },
  { value: 'escritorio_homeoffice', label: 'Escritório e Home Office' },
  { value: 'teto_vidro_claraboia', label: 'Teto de Vidro e Claraboia' },
